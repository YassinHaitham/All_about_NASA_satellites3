...
.method public compile(Lgnu/expr/ApplyExp;Lgnu/expr/Compilation;Lgnu/expr/Target;)V
    ...
    if-lt v14, v3, :cond_eb

    const/4 v3, 0x4

    if-gt v14, v3, :cond_eb
    ...
    if-le v14, v3, :cond_96

    const/4 v3, 0x6

    if-ge v14, v3, :cond_96

    const/16 v3, 0x9

    if-gt v14, v3, :cond_124
    ...
    if-gt v14, v3, :cond_181

    const/16 v3, 0x8

    if-eq v14, v3, :cond_181
    ...
    if-eq v14, v3, :cond_ae

    const/4 v3, 0x4

    if-le v14, v3, :cond_174

    .line 225
    :cond_ae
    const/4 v3, 0x6

    if-ne v14, v3, :cond_170
    ...
    if-le v14, v3, :cond_10b

    const/16 v3, 0xa

    if-gt v14, v3, :cond_10b
    ...
    if-gt v14, v3, :cond_130

    const/4 v3, 0x7

    if-ne v14, v3, :cond_139
    ...
    if-eq v14, v3, :cond_1ec

    const/16 v3, 0x8

    if-ne v14, v3, :cond_269
    ...
    .local v13, "i":I
    :goto_205
    if-ge v13, v15, :cond_dd

    .line 260
    const/4 v3, 0x1

    if-ne v13, v3, :cond_220
    ...
    .line 265
    :cond_22e
    packed-switch v14, :pswitch_data_26e
