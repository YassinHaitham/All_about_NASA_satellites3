...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/MenuBuilder;Landroid/view/View;IIZ)V
    ...
    iput v2, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mDropDownGravity:I
    ...
    iget-boolean v3, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mOverflowOnly:Z

    sget v4, Landroidx/appcompat/view/menu/StandardMenuPopup;->ITEM_LAYOUT:I

    invoke-direct {v2, p2, v0, v3, v4}, Landroidx/appcompat/view/menu/MenuAdapter;-><init>(Landroidx/appcompat/view/menu/MenuBuilder;Landroid/view/LayoutInflater;ZI)V
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroidx/appcompat/widget/MenuPopupWindow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private tryShow()Z
    ...
    .line 153
    :cond_a
    iget-boolean v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mWasDismissed:Z

    if-nez v7, :cond_12

    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mAnchorView:Landroid/view/View;
    ...
    iput-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mShownAnchorView:Landroid/view/View;

    .line 159
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v7, p0}, Landroidx/appcompat/widget/MenuPopupWindow;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 160
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v7, p0}, Landroidx/appcompat/widget/MenuPopupWindow;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 161
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v7, v5}, Landroidx/appcompat/widget/MenuPopupWindow;->setModal(Z)V
    ...
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iput-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iget-object v8, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v7, v8}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    .line 169
    :cond_3d
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;
    ...
    invoke-virtual {v7, v1}, Landroidx/appcompat/widget/MenuPopupWindow;->setAnchorView(Landroid/view/View;)V

    .line 171
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;

    iget v8, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mDropDownGravity:I

    invoke-virtual {v7, v8}, Landroidx/appcompat/widget/MenuPopupWindow;->setDropDownGravity(I)V

    .line 173
    iget-boolean v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mHasContentWidth:Z
    ...
    iget-object v8, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mContext:Landroid/content/Context;

    iget v9, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopupMaxWidth:I

    invoke-static {v7, v10, v8, v9}, Landroidx/appcompat/view/menu/StandardMenuPopup;->measureIndividualMenuWidth(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v7

    iput v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mContentWidth:I

    .line 175
    iput-boolean v5, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mHasContentWidth:Z

    .line 178
    :cond_60
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;

    iget v8, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mContentWidth:I

    invoke-virtual {v7, v8}, Landroidx/appcompat/widget/MenuPopupWindow;->setContentWidth(I)V
    ...
    invoke-virtual {v7, v8}, Landroidx/appcompat/widget/MenuPopupWindow;->setInputMethodMode(I)V
    ...
    invoke-virtual {v7, v8}, Landroidx/appcompat/widget/MenuPopupWindow;->setEpicenterBounds(Landroid/graphics/Rect;)V

    .line 181
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v7}, Landroidx/appcompat/widget/MenuPopupWindow;->show()V

    .line 183
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v7}, Landroidx/appcompat/widget/MenuPopupWindow;->getListView()Landroid/widget/ListView;
    ...
    .line 186
    iget-boolean v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mShowTitle:Z

    if-eqz v7, :cond_b8

    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mMenu:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    .line 187
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mContext:Landroid/content/Context;
    ...
    :cond_b8
    iget-object v6, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;
...
.method public onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
    ...
    invoke-virtual {v1, v10}, Landroidx/appcompat/view/menu/MenuBuilder;->close(Z)V
    ...
    invoke-virtual {v1}, Landroidx/appcompat/widget/MenuPopupWindow;->getVerticalOffset()I
    ...
    .line 285
    iget-object v1, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mAnchorView:Landroid/view/View;
    ...
    .line 288
    :cond_54
    invoke-virtual {v0, v8, v9}, Landroidx/appcompat/view/menu/MenuPopupHelper;->tryShow(II)Z
