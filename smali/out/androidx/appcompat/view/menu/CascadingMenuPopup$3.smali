...
.method public onItemHoverEnter(Landroidx/appcompat/view/menu/MenuBuilder;Landroid/view/MenuItem;)V
    ...
    .prologue
    .line 150
    iget-object v8, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup$3;->this$0:Landroidx/appcompat/view/menu/CascadingMenuPopup;

    iget-object v8, v8, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mSubMenuHoverHandler:Landroid/os/Handler;
    ...
    .line 173
    .local v4, "nextInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    :goto_40
    new-instance v5, Landroidx/appcompat/view/menu/CascadingMenuPopup$3$1;

    invoke-direct {v5, p0, v4, p2, p1}, Landroidx/appcompat/view/menu/CascadingMenuPopup$3$1;-><init>(Landroidx/appcompat/view/menu/CascadingMenuPopup$3;Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;Landroid/view/MenuItem;Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    .line 170
    .end local v4    # "nextInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    .end local v5    # "runnable":Ljava/lang/Runnable;
    .end local v6    # "uptimeMillis":J
    :cond_55
    const/4 v4, 0x0

    .restart local v4    # "nextInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    goto :goto_40
.end method
